...
export default function RefactorTaskList() {
  const tasks = {
    ...
    high: [
      { id: 14, title: "Rate Limiting - API Protection", status: "in-progress", priority: "high" },
      { id: 15, title: "Error Handling - Global Error Boundaries", status: "in-progress", priority: "high" },
    ...
    medium: [
      { id: 26, title: "Analytics Dashboard - Business Metrics", status: "in-progress", priority: "medium" },
    ...
    low: [
      ...
      { id: 53, title: "Live Chat Support - Customer Service", status: "in-progress", priority: "low" },
