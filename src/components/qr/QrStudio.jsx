  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList className="w-full overflow-x-auto flex-wrap md:flex-nowrap mb-6">
          <TabsTrigger value="create" className="min-h-[44px]">
          ...
          <TabsTrigger value="customize" className="min-h-[44px]">
            Customize
          </TabsTrigger>
          <TabsTrigger value="hotzones" className="min-h-[44px]">
            <Layers className="w-4 h-4 mr-2" />
            Hot Zones
          </TabsTrigger>
          <TabsTrigger value="stego" className="min-h-[44px]">
            Stego Art
          </TabsTrigger>
          ...
          <TabsTrigger value="bulk" className="min-h-[44px]">
            Bulk
          </TabsTrigger>
        </TabsList>
