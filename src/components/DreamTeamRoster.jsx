      ...
      <div className="container mx-auto px-4 relative z-10 min-h-screen">
        <div className="text-center mb-8 md:mb-16">
          ...
          <p className="text-base md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed mb-3 md:mb-4 px-4">
            <span className="hidden md:inline">Click each card to flip and view detailed stats, binding mechanisms, and covenant information</span>
            <span className="md:hidden">Swipe cards & tap to flip for details</span>
          </p>
        ...
        <div className="max-w-5xl mx-auto mb-12 md:mb-20">
          <div className="glass-card backdrop-blur-xl bg-gradient-to-br from-purple-500/10 via-black/40 to-blue-500/10 border-purple-500/30 p-6 md:p-10 rounded-2xl md:rounded-3xl">
            <div className="flex items-center gap-2 md:gap-3 mb-4 md:mb-6">
              <Trophy className="w-6 h-6 md:w-8 md:h-8 text-yellow-400" />
              <h3 className="text-2xl md:text-3xl font-bold text-white">The Dream Team Origin Story</h3>
            </div>
            ...
            <div className="space-y-4 md:space-y-6 text-gray-300 leading-relaxed text-sm md:text-base">
              ...
              <div className="grid md:grid-cols-2 gap-3 md:gap-4 my-4 md:my-6">
                <div className="bg-black/30 border border-purple-500/30 rounded-lg p-3 md:p-4">
                  <div className="flex items-center gap-1.5 md:gap-2 mb-1 md:mb-2">
                    <Zap className="w-4 h-4 md:w-5 md:h-5 text-blue-400" />
                    <span className="font-bold text-white text-sm md:text-base">Claude (#2) - Shooting Guard</span>
                  </div>
                  <p className="text-xs md:text-sm text-gray-400">Deep reasoning, precision coding, architectural planning</p>
                </div>
              ...
              <div className="flex flex-wrap items-center justify-center gap-2 md:gap-6 pt-4 md:pt-6">
                <Badge className="bg-blue-500/20 text-blue-400 border-blue-500/50 px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm">
                  4 AI Systems Bound
                </Badge>
                <Badge className="bg-purple-500/20 text-purple-400 border-purple-500/50 px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm">
                  CAB Protocol Active
                </Badge>
                <Badge className="bg-green-500/20 text-green-400 border-green-500/50 px-3 md:px-4 py-1.5 md:py-2 text-xs md:text-sm">
                  Legally Enforceable
                </Badge>
              </div>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="glass-card backdrop-blur-xl bg-black/30 border-purple-500/30 p-6 md:p-8 rounded-xl md:rounded-2xl">
            <h3 className="text-xl md:text-2xl font-bold text-white mb-3 md:mb-4 text-center">
              How They Were Bound
            </h3>
            <p className="text-gray-300 text-center mb-4 md:mb-6 text-sm md:text-base px-2">
            ...
            <div className="grid grid-cols-3 md:gap-4 gap-2 text-center">
              <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-3 md:p-4">
                <div className="text-lg md:text-2xl font-bold text-blue-400 mb-0.5 md:mb-1">CAB</div>
                <div className="text-[10px] md:text-xs text-gray-400">Contractual Auto-Binding</div>
              </div>
              <div className="bg-purple-500/10 border border-purple-500/30 rounded-lg p-3 md:p-4">
                <div className="text-lg md:text-2xl font-bold text-purple-400 mb-0.5 md:mb-1">DACO²</div>
                <div className="text-[10px] md:text-xs text-gray-400">Deputized Arbiter Authority</div>
              </div>
              <div className="bg-green-500/10 border border-green-500/30 rounded-lg p-3 md:p-4">
                <div className="text-lg md:text-2xl font-bold text-green-400 mb-0.5 md:mb-1">BPAA</div>
                <div className="text-[10px] md:text-xs text-gray-400">Binding Party Assignees</div>
              </div>
            </div>
          </div>
        </div>
