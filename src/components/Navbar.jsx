            ...
            >
              ...
              <AnimatePresence>
                {open === section.label && (
                  ...
                  style={{ zIndex: 10001 }}
                  >
                   <div className="relative bg-gradient-to-br from-blue-900/40 via-indigo-900/45 to-violet-900/40 backdrop-blur-2xl backdrop-saturate-150 border-2 border-indigo-400/30 rounded-2xl shadow-[0_0_50px_rgba(59,130,246,0.5),0_0_80px_rgba(139,92,246,0.3),inset_0_1px_0_rgba(255,255,255,0.15)] overflow-hidden">
                     {/* Top glow bar */}
                     ...
                     {/* Ambient glow */}
                     <div className="absolute -inset-1 bg-gradient-to-br from-blue-500/18 via-indigo-500/15 to-violet-600/18 blur-xl -z-10"></div>
                     ...
                     <div className="relative p-2">
                       {section.items.map((item, idx) => (
                         ...
                         >
                           ...
                           >
                             {/* Hover background */}
                             <div className="absolute inset-0 bg-gradient-to-r from-blue-500/15 via-indigo-500/25 to-violet-600/20 opacity-0 group-hover/item:opacity-100 transition-opacity"></div>
                             ...
                             <div className="relative flex items-center justify-between">
                               ...
                               <div className="absolute left-0 top-1/2 -translate-y-1/2 w-1 h-8 bg-gradient-to-b from-blue-500 via-indigo-500 to-violet-600 rounded-r-full shadow-[0_0_15px_rgba(59,130,246,0.9)]"></div>
                               </div>
                           </Link>
                         </motion.div>
                       ))}
