...
/**
 * GlyphBot LLM Engine v7.0 — Multi-Provider
 * 
 * PRIMARY: Google Gemini 3 Pro Preview (FREE)
 * SECONDARY: OpenRouter (paid, multi-model access)
 * FALLBACK: Local OSS Engine
 * 
 * Environment Variables:
 * - GEMINI_API_KEY: Google Gemini (FREE - Primary)
...
To enable full GlyphBot capabilities, configure GEMINI_API_KEY or OPENROUTER_API_KEY.`;
